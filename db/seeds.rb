...
Room.create(name: "Madonna")
Room.create(name: "Vampyr")
Room.create(name: "Resturant")

Timeslot.create(start: "2013-11-05 08:00:00", end: "2013-11-05 08:45:00")
Timeslot.create(start: "2013-11-05 08:45:00", end: "2013-11-05 09:00:00")
Timeslot.create(start: "2013-11-05 09:00:00", end: "2013-11-05 10:00:00")
Timeslot.create(start: "2013-11-05 10:15:00", end: "2013-11-05 11:00:00")